...
#    Updated: 2024/04/24 14:38:46 by daniloceano      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Load the dataset
ds = xr.open_dataset('../data_etc/netCDF_files/Akara-subset_ERA5.nc')

# Load periods
periods = pd.read_csv('./LEC_Akara-subset_ERA5_track/periods.csv', parse_dates=['start', 'end'], index_col=0)
periods = periods.sort_values('start')

# Load track file
track = pd.read_csv('./LEC_Akara-subset_ERA5_track/Akara-subset_ERA5_track_trackfile', sep=';', index_col=0)
...
print('Calculating potential temperature and potential vorticity...')
...
print('Calculating the y-derivative of PV...')
...
# Adjust layout
plt.tight_layout()
plt.savefig('figures/barotropic_instability.png')
print('Done!')
